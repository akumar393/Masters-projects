...
/*void list_insert_ordered_condvar(struct list *list, struct semaphore_elem *eleme, list_less_func *less)
{
	...
	for(e = list_begin(list); e != list_end(list); e = list_next(e))
		if(less(&(eleme->elem), &(e->elem), NULL))
			break;
	return list_insert(e, eleme);
}*/
