...
// The explanation for the timer scheme used in this code is given in the Analysis_Assignment2 report.
int N;
...
void A_timerinterrupt()
{
	...
	currentseq = p[0].store.seqnum;
     float current = get_sim_time();   //200   //250
	         ...
	         float rem_time = p[0].timeout - current; 
